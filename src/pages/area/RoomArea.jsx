          ...
          {result && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">{t.area[language]}</p>
                  <p className="text-2xl font-bold text-blue-600">{result.area} m²</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">{t.volume[language]}</p>
                  <p className="text-2xl font-bold text-blue-600">{result.volume} m³</p>
                </div>
              </div>
            </div>
          )}
